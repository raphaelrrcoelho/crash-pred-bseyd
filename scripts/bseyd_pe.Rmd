...
signal_data = readxl::read_xlsx('../dados/SC_signal_data_pe.xlsx', range = 'A2:T15479')

colnames(signal_data) = c('Dates', 'spx_index',	'rty_index',	'gt10_govt',	'mxeu_index',	'gteur10y_govt', 'mxcn_index', 'gtcny10y_govt', 'ibov_index', 'gtbrl10y_govt', 'small_index',	'spx_earnings',	'rty_earnings',	'gt10_earnings',	'mxeu_earnings',	'gteur10y_earnings', 'mxcn_earnings', 'gtcny10y_earnings', 'ibov_earnings', 'gtbrl10y_earnings', 'small_earnings')
...
signal_data = 
  signal_data %>% 
  mutate(bseyd = gtcny10y_govt - (1/mxcn_earnings))
